...
//        var_dump($data->items());
        ...
        $categoryTree        = $portalCategoryModel->adminCategoryTree(3, $categoryId);
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminAddPage($data['post'], 3);

            if (!empty($data['post']['post_alias'])){
                $routeModel = new RouteModel();
                $routeUrl   = $data['post']['post_alias'];
                $routeModel->setRoute($routeUrl, 'portal/index/industries_info', ['id' => $portalPostModel->id], 2, 5000);

                $routeModel->getRoutes(true);
            }

            $this->success('添加成功!', url('AdminCase/index'));
        }
    ...
    public function edit()
    {
        ...
        $routeModel         = new RouteModel();
        $alias              = $routeModel->getUrl('portal/index/industries_info', ['id' => $id]);
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $portalPostModel->adminEditPage($data['post'], 3);

            if (!empty($data['post']['post_alias'])){
                $routeModel = new RouteModel();
                $routeUrl   = $data['post']['post_alias'];
                $routeModel->setRoute($routeUrl, 'portal/index/industries_info', ['id' => $data['post']['id']], 2, 5000);
