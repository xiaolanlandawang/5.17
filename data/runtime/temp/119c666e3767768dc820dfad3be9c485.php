<?php /*a:4:{s:75:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/portal\\privacy.html";i:1780039962;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\head.html";i:1779697000;s:70:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\nav.html";i:1779090902;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\foot.html";i:1780040179;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="header">
    <div class="logo">
        <a href="/">
            <img class="logo-img" src="/themes/simpleboot3_mobile/public/assets/images/logo.svg"
                    ...
                    <ul class="nav-sub-ul">
                        <li>
                            <a href="<?php echo cmf_url('portal/index/about'); ?>">
                                <div class="nav-sub-title">About Weihua</div>
                            </a>
                        </li>
                        <li>
...
<!--NAV END-->
    ...
    <div class="mobile-breadcrumb" style="margin: 1.6rem 0; width: 100%; padding: 0 1.6rem;">
        <a href="/">Home</a>
        <span>/</span>
    ...
    <div class="privacy-container">
        ...
        <div class="privacy-content">
            <p>At Weihua Crane Global, we value your privacy. This policy outlines how we handle your personal information.</p>
            <p><strong>1. Information Collection:</strong> We collect your name, phone number, and email when you submit a lead form to request a crane quote.</p>
            <p><strong>2. Use of Information:</strong> Your data is used solely to provide the requested product information, quotes, and follow-up services.</p>
            <p><strong>3. Data Security:</strong> We implement security measures to protect your information and do not share it with unauthorized third parties.</p>
            <p><strong>4. Contact Us:</strong> For any questions regarding your data, please contact us at <a href="mailto:sales01@weihuahenancrane.com">sales01@weihuahenancrane.com</a>.</p>
        </div>
    </div>
