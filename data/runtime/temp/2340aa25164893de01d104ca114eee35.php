<?php /*a:5:{s:77:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/portal\\news-info.html";i:1779937926;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\head.html";i:1779697000;s:70:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\nav.html";i:1779090902;s:73:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\banner.html";i:1778898373;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\foot.html";i:1779412113;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="content">
  <div class="mobile-breadcrumb" style="margin: 0 0 1.6rem 0; width: 100%;">
      <a href="/">Home</a>
      <span>/</span>
      <a href="<?php echo cmf_url('portal/index/news'); ?>">News</a>
      <span>/</span>
      <span>Detail</span>
  </div>
  ...
  <div class="content-bottom">
    <div class="prev">
      ...
      <?php if(!(empty($prev_article) || (($prev_article instanceof \think\Collection || $prev_article instanceof \think\Paginator ) && $prev_article->isEmpty()))): ?>
        <a href="<?php if(empty($prev_article['post_alias']) || (($prev_article['post_alias'] instanceof \think\Collection || $prev_article['post_alias'] instanceof \think\Paginator ) && $prev_article['post_alias']->isEmpty())): ?><?php echo cmf_url('portal/index/news_info',array('id'=>$prev_article['id'],'cid'=>$category['id'])); else: ?>/<?php echo $prev_article['post_alias']; ?>.html<?php endif; ?>">
    ...
    <div class="next">
      ...
      <?php if(!(empty($next_article) || (($next_article instanceof \think\Collection || $next_article instanceof \think\Paginator ) && $next_article->isEmpty()))): ?>
        <a href="<?php if(empty($next_article['post_alias']) || (($next_article['post_alias'] instanceof \think\Collection || $next_article['post_alias'] instanceof \think\Paginator ) && $next_article['post_alias']->isEmpty())): ?><?php echo cmf_url('portal/index/news_info',array('id'=>$next_article['id'],'cid'=>$category['id'])); else: ?>/<?php echo $next_article['post_alias']; ?>.html<?php endif; ?>">
