<?php /*a:5:{s:66:"C:\laragon\www\weihua\public/themes/simpleboot3/portal\\about.html";i:1778826919;s:64:"C:\laragon\www\weihua\public/themes/simpleboot3/public\head.html";i:1778833257;s:63:"C:\laragon\www\weihua\public/themes/simpleboot3/public\nav.html";i:1778986208;s:66:"C:\laragon\www\weihua\public/themes/simpleboot3/public\banner.html";i:1736500544;s:64:"C:\laragon\www\weihua\public/themes/simpleboot3/public\foot.html";i:1778835931;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="about-content reveal">
    <div class="title">WHE WE ARE?</div>
    <div class="about-introduction"><?php echo htmlspecialchars_decode($about_site['introduction']); ?></div>
    <div class="about-introduction-img">
        <img src="<?php echo cmf_get_image_url($about_site['left_image']); ?>" alt="introduction">
    </div>
</div>
...
<div class="advantage reveal">
    <div class="title">WEIHUA ADVANTAGES</div>
    <div class="advantage-list">
        <?php if(is_array($about_site['advantage']) || $about_site['advantage'] instanceof \think\Collection || $about_site['advantage'] instanceof \think\Paginator): if( count($about_site['advantage'])==0 ) : echo "" ;else: foreach($about_site['advantage'] as $key=>$vo): ?>
            <div class="advantage-item">
                <div class="advantage-item-num"><?php echo $vo['advantage_num']; ?></div>
                <div class="advantage-item-title"><?php echo $vo['advantage_name']; ?></div>
            </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
