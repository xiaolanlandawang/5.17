<?php /*a:5:{s:72:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/portal\\news.html";i:1779948182;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\head.html";i:1779697000;s:70:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\nav.html";i:1779090902;s:73:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\banner.html";i:1778898373;s:71:"C:\laragon\www\weihua\public/themes/simpleboot3_mobile/public\foot.html";i:1779412113;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="category-list">
        <ul>
            <?php if(is_array($news_category) || $news_category instanceof \think\Collection || $news_category instanceof \think\Paginator): if( count($news_category)==0 ) : echo "" ;else: foreach($news_category as $key=>$vo): ?>
                <li class="category-item <?php echo input('id')==$vo['id'] ? 'active' : ''; ?>" onclick="location.href='<?php echo cmf_url('portal/index/news',['id'=>$vo['id']]); ?>'">
                <?php echo $vo['name']; ?>
                </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    ...
    <div class="products-list">
        <ul class="clearfix">
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <li onclick="location.href='<?php echo cmf_url('portal/index/news_info',['cid'=>$vo['cid'],'id'=>$vo['id']]); ?>'">
                <div class="item-img">
