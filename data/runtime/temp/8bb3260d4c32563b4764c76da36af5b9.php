<?php /*a:4:{s:63:"/www/wwwroot/weihua/public/themes/simpleboot3/portal/index.html";i:1778985638;s:62:"/www/wwwroot/weihua/public/themes/simpleboot3/public/head.html";i:1778833257;s:61:"/www/wwwroot/weihua/public/themes/simpleboot3/public/nav.html";i:1778986208;s:62:"/www/wwwroot/weihua/public/themes/simpleboot3/public/foot.html";i:1778835931;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="swiper-slide">
                            <ul class="products-list">
                                <?php if(is_array($vo['list']) || $vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator): if( count($vo['list'])==0 ) : echo "" ;else: foreach($vo['list'] as $key=>$v): ?>
                                    <li>
                                        <a href="<?php echo cmf_url('portal/index/product_info',array('id'=>$v['id'])); ?>">
                                            <div class="product_list_item_img">
                                                <img loading="lazy" src="<?php echo cmf_get_image_url($v['thumbnail']); ?>" alt="<?php echo $v['title']; ?>"
                                                    title="<?php echo $v['title']; ?>">
                                            </div>
                                            <div class="product_list_item_title"><?php echo $v['title']; ?></div>
                                            <div class="product_list_item_category"><?php echo $v['industry']; ?></div>
                                        </a>
